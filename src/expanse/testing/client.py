    ...
    def handle_request(self, request: httpx.Request) -> httpx.Response:
        ...
        with self.portal_factory() as portal:
            ...
            handler: ExceptionHandler = portal.call(
                self.app.container.get, ExceptionHandler
            )
...
class TestClient(BaseClient):
    ...
    def handle_exceptions(
        ...
        raise_server_exceptions = self._transport.raise_server_exceptions
        self._transport.raise_server_exceptions = not handle_exceptions

        yield

        self._transport.raise_server_exceptions = raise_server_exceptions
