...
def create_engine[T: Engine](
    ...
    when having a custom connection class that extends the base AsyncConnection class.
    """
    ...
    if _initialize:
        ...
        def first_connect(
            ...
            c = base.Connection(
                ...
                # connection goes away, AsyncConnection is then closed
            ...
            try:
                ...
                # exclusive in 1.4 AsyncConnection.
