...
from expanse.support.exceptions.frame_collection import FrameCollection


class Inspector:
    def __init__(self, exception: BaseException):
        self._exception: BaseException = exception
        self._frames: FrameCollection | None = None
        self._previous_exception: BaseException | None = exception.__context__
