...
from expanse.common.console.command_loader import CommandLoader
...
class Console(Generic[TCommand], ABC):
    def __init__(self) -> None:
        ...
        self._command_loader: CommandLoader[TCommand] = CommandLoader({})
        self._solution_provider_repository: SolutionProviderRepository | None = None

        self._commands: dict[str, TCommand] = {}
        self._running_command: TCommand | None = None
    ...
    @property
    def default_commands(self) -> list[TCommand]:
        return []
    ...
    @property
    def command_loader(self) -> CommandLoader[TCommand]:
    ...
    def set_command_loader(self, command_loader: CommandLoader[TCommand]) -> None:
    ...
    @abstractmethod
    def get_help_command(self, command: TCommand) -> TCommand: ...
    ...
    def find(self, name: str) -> TCommand:
        self._init()
    ...
    def all(self, namespace: str | None = None) -> dict[str, TCommand]:
        self._init()
