...
async def setup_app(app: Application) -> None:
    ...
    (await app.container.get("config"))["cors"] = {
        "paths": ["api/*"],
...
async def test_allow_all_origins(
    ...
    (await client.app.container.get("config"))["cors"]["allowed_origins"] = ["*"]
    response = client.options(
        "/api/ping",
        headers={"Origin": "http://localhost", "Access-Control-Request-Method": "POST"},
    )
...
async def test_method_allow_all_methods_allowed(
    ...
    (await client.app.container.get("config"))["cors"]["allowed_methods"] = ["*"]
...
async def test_allowed_headers_allow_wildcard(
    ...
    (await client.app.container.get("config"))["cors"]["allowed_headers"] = ["*"]
...
async def test_supports_credentials(
    ...
    (await client.app.container.get("config"))["cors"]["supports_credentials"] = True
    response = client.options(
        "/api/ping",
        headers={
            "Origin": "http://localhost",
...
async def test_exposed_headers(
    ...
    (await client.app.container.get("config"))["cors"]["exposed_headers"] = ["X-Foo"]
    response = client.post(
        "/api/ping",
        headers={
            "Origin": "http://localhost",
