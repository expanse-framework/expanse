...
async def redirection_to_url(redirect: Redirect) -> Response:
    return await redirect.to("/destination")
...
async def redirection_to_named_route_with_parameters(redirect: Redirect) -> Response:
