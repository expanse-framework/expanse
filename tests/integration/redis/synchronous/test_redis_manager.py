...
def test_default_connection(config: Config) -> None:
...
def test_named_connection(config: Config) -> None:
    manager = RedisManager(config)
...
def test_connection_with_no_backoff(config: Config) -> None:
    manager = RedisManager(config)
...
def test_connection_with_constant_backoff(config: Config) -> None:
    manager = RedisManager(config)
...
def test_connection_with_generic_backoff_strategies(
...
def test_connection_with_cluster(config: Config, mocker: MockerFixture) -> None:
